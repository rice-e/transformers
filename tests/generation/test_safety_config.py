...
class TestSafetyConfig(unittest.TestCase):
    """Test suite for SafetyConfig using watermarking pattern."""
    ...
    def test_default_config(self):
        ...
        # Check default values (watermarking pattern - checker must be provided by user)
    ...
    def test_serialization_round_trip(self):
        ...
        # Check dict contents (checker is not serialized per watermarking pattern)
    ...
    def test_comprehensive_workflow(self):
        """Test a complete workflow with SafetyConfig using watermarking pattern."""
        # Create configuration using from_checker (recommended pattern)
